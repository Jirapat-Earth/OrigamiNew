        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                onPressed: () => setState(() {
                  // final Uri _url = Uri.parse('https://pub.dev/documentation/url_launcher/latest/link/link-library.html');
                  // _launched = _launchInBrowserView(_url);
              ...
              Link(
                uri: Uri.parse(
                    'https://www.youtube.com/watch?v=NqgcPW8uLuA'),
